...
namespace DungeonAssist
{
    public class AurumVale
    {
        ...
        {
            //Lockhart
            if (GameObjectManager.GetObjectByNPCId(1534) != null && Core.Me.HasAura(302) &&
                Core.Me.GetAuraById(302).Value > 2) //Gold Lung
            {
            ...
            //Miser's Mistress 
            if (GameObjectManager.GetObjectByNPCId(1532) != null && Core.Me.HasAura(303) &&
                Core.Me.GetAuraById(303).Value > 2) //Burrs
            {
